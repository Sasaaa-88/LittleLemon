...
SECRET_KEY = 'django-insecure-axhwubix)p4d8%7rc4mo1f_z$*fp)q)wqk@9rv9x#tmei0pl9g'
...
# Global static directory for the whole project
STATIC_URL = 'static/'
...
# Local static directories for each app in the project
STATICFILES_DIRS = [
    "restaurant/static",
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # To use token authentication with djoser authentication, this line must be added
        'rest_framework.authentication.SessionAuthentication',
    ),
    # 'DEFAULT_THROTTLE_RATES': {
    #     'anon':'2/minute', #second / hour / day
    #     'user':'5/minute',
    #     'ten':'10/minute',
    # },
}
